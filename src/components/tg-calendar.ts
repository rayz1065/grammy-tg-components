 ...
 */
export function tgCalendarLocaleDataFromDayjs(localeData: {
  firstDayOfWeek(): number;
 ...
 *   ctx,
 *   calendarLocaleData: tgCalendarLocaleDataFromDayjs(
 *     dayjs().locale('it').localeData()
 *   ),
 * });
 * ```
 */
